...
import net.rhian.agathe.util.chatlisten.ChatListenCallback;
                ...
                if(e.getCurrentItem().getType() != Material.AIR){
                    ...
                    if(e.getInventory().getName().equalsIgnoreCase(mainInventoryName)){
                        ...
                        if(m == Material.GOLD_INGOT){
                            ...
                            //Runner
                            KiteQueue queue = (KiteQueue) Agathe.getQueueManager().getQueue(QueueType.KITE);
                            ...
                            new ChatListenCallback(player){
                                ...
                                public void callback(String message) {
                                    ...
                                    if(target != null){
                                        ...
                                        unregister();
                                        new KiteRequest(Agathe.getCache().getIPlayer(player), Agathe.getCache().getIPlayer(target), player, target)
                                                .send();
                                    }
                                    else{
                            ...
                            new ChatListenCallback(player){
                                ...
                                public void callback(String message) {
                                    ...
                                    if(target != null){
                                        ...
                                        unregister();
                                        new KiteRequest(Agathe.getCache().getIPlayer(player), Agathe.getCache().getIPlayer(target), target, player)
                                                .send();
                                    }
                                    else{
                                        player.sendMessage(ChatColor.RED+"Player '"+message+"' not found.");
