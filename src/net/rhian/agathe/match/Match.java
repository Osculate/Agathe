    ...
    private void sendEloChanges(Map<String, Integer> before, Map<String, Integer> after) {
        for (MatchPlayer mp : playerManager.getMatchPlayers()) {
            ...
            for (String k : before.keySet()) {
                IPlayer kip = Agathe.getCache().getIPlayer(k);
