...
public abstract class AutoMongo {
    ...
    public void update() {
        ...
        MongoCollection<Document> col = Agathe.getDbManager().getDb().getCollection(tableName);
    ...
    public static List<AutoMongo> select(BasicDBObject search, Class<? extends AutoMongo> type) {
        ...
        MongoCollection<Document> col = Agathe.getDbManager().getDb().getCollection(collectionName.name());
