    ...
    public void onCommand(final CmdArgs cmdArgs) {
        ...
        if(key.equalsIgnoreCase("addladder")){
            if(args.length >= 4){
                ...
                Ladder ladder = new Ladder(Agathe.getPlugin(), name, icon, editable);
                ladder.register();
            ...
            if(args.length >= 2){
                ...
                Selection selection = Agathe.getWorldEdit().getSelection(p);
                if(selection != null) {
                    BasicArena arena = new BasicArena(Agathe.getPlugin(), Agathe.getArenaManager().getNextArenaIndex(), name, p.getLocation(), p.getLocation(),
            ...
            if(args.length >= 2){
                try {
                    ...
                    Arena arena = Agathe.getArenaManager().getArena(id);
                    if(arena != null) {
            ...
            if(Agathe.getArenaManager().getArenas().isEmpty()){
                ...
                for(Arena arena : Agathe.getArenaManager().getArenas()){
        ...
        //KITE ARENAS
            ...
            if(args.length >= 2){
                ...
                if(selection != null) {
                    ...
                    KiteArena arena = new KiteArena(Agathe.getPlugin(), Agathe.getArenaManager().getNextArenaIndex(), name, p.getLocation(), p.getLocation(),
            ...
            if(args.length >= 3){
                try {
                    ...
                    Arena a = Agathe.getArenaManager().getArena(id);
