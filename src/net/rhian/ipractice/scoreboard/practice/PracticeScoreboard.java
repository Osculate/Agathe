package net.rhian.ipractice.scoreboard.practice;
...
import net.rhian.ipractice.scoreboard.practice.state.KitBuilderBoardType;
import net.rhian.ipractice.scoreboard.practice.state.MatchBoardType;
import net.rhian.ipractice.scoreboard.practice.state.PartyBoardType;
import net.rhian.ipractice.scoreboard.practice.state.PracticeBoardType;
import net.rhian.ipractice.scoreboard.practice.state.QueueBoardType;
import net.rhian.ipractice.scoreboard.practice.state.SpawnBoardType;
import net.rhian.ipractice.scoreboard.practice.state.StaffModeBoardType;
...
public class PracticeScoreboard {
    ...
    public PracticeScoreboard(IPlayer ip) {
        this.ip = ip;
        this.scoreboard = new XScoreboard(ChatColor.translateAlternateColorCodes('&', Practice.getIConfig().getScoreboardTitle()));
