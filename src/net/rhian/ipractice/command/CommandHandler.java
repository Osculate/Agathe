package net.rhian.ipractice.command;
...
import net.rhian.ipractice.command.commands.CommandAccept;
import net.rhian.ipractice.command.commands.CommandDuel;
import net.rhian.ipractice.command.commands.CommandKiteAccept;
import net.rhian.ipractice.command.commands.CommandPAccept;
import net.rhian.ipractice.command.commands.CommandPDuel;
import net.rhian.ipractice.command.commands.CommandParty;
import net.rhian.ipractice.command.commands.CommandPractice;
import net.rhian.ipractice.command.commands.CommandResetElo;
import net.rhian.ipractice.command.commands.CommandSave;
import net.rhian.ipractice.command.commands.CommandStaffMode;
import net.rhian.ipractice.command.commands.CommandViewInventory;
import net.rhian.ipractice.command.commands.CommandWatch;
